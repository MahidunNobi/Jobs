      ...
      <div className="container mx-auto px-3 min-h-screen flex flex-col justify-center items-center">
        ...
        <div className="border border-gray-300 rounded-xl px-6 md:px-16 py-4 md:py-6 space-y-6 md:mt-6">
          ...
          <div className=" flex flex-col justify-center items-center gap-6">
            ...
            <ButtonBordered text={"Sign Up"} aditionalClass={"min-w-[130px]"} />
          </div>
        </div>
        <footer className="container mx-auto bg-dark-grn text-white rounded-lg min-h-[200px] px-16 flex justify-center items-center mt-16 mb-6">          
          <p className="inline text-xs text-center"> © 2015 - 2024 Upwork® Global Inc. <li className="inline hover:underline cursor-pointer"> • Privacy Policy </li></p>
