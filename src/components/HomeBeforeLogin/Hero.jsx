    ...
    <section>
        <div className="container mx-auto px-3">
            <ul className='hidden lg:flex gap-6  *:text-base *:cursor-pointer py-4'>
                ...
                <li className='hover:text-grn hover:underline'>Design and Creative</li>
                <li className='hover:text-grn hover:underline'>Sals & Marketing</li>
                <li className='hover:text-grn hover:underline'>Admin and Customer Support</li>
            ...
            <div className="heroContainer lg:flex lg:justify-between lg:items-center mt-10">
                ...
                <div className='lg:w-[45%]'>
                    <h1 className='text-6xl md:text-8xl tracking-tight text-grn'>How work <br /> should work</h1>
                    ...
                    <div className="flex gap-6">
                        <Image width={80} height={40} src={"/microsoft.svg"} alt='Microsoft Logo' />
                        <Image width={80} height={40} src={"/airbnb.svg"} alt='Airbnb Logo' />
                        <Image width={80} height={40} src={"/bissell.svg"} alt='Bissell Logo' />
                    </div>
                </div>
                {/* Hero Right */}
                <div className='hidden lg:block w-[45%]'>
                    <Image width={500} height={500} alt='Hero Right Image' src={"/Hero-Right-Image.webp"} />
                </div>
            </div>
        </div>        
    </section>
